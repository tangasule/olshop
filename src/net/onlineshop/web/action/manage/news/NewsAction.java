 ...
 * 
 */
package net.onlineshop.web.action.manage.news;
...
//		e.setType(type);
	...
	public String insert() throws Exception {
		logger.debug("NewsAction code = " + e.getCode());
	...
	public String update() throws Exception {
		logger.debug("NewsAction code = ");
		logger.debug("NewsAction code = " + e.getCode()+",id="+e.getId());
//		getE().setStatus(News.news_status_n);//未审核
...
//		logger.debug("NewsAction.selectList.type="+type);
		super.selectList();
		return toList;
	}
...
//		return super.deletes();
		logger.debug("1..type="+e.getType());
		getServer().deletes(getIds());
		logger.debug("2..type="+e.getType());
		return selectList();
	}
