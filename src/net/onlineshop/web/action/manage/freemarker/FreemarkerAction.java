package net.onlineshop.web.action.manage.freemarker;
///**
// * 2012-7-8
// * 
// */
//package net.onlineshop.web.action.freemarker;
//
...
//
//import net.onlineshop.core.Container;
//import net.onlineshop.core.freemarker.FreemarkerHelper;
//import net.onlineshop.services.account.bean.Account;
//import net.onlineshop.services.news.bean.News;
//import net.onlineshop.services.version.VersionService;
//import net.onlineshop.services.version.bean.Version;
//import net.onlineshop.services.version.impl.VersionServiceImpl;
//import net.onlineshop.web.action.system.BaseAction;
//
///**
// * 网站会员action
// * 
