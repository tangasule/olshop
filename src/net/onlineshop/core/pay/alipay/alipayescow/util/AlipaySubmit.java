package net.onlineshop.core.pay.alipay.alipayescow.util;
...
import net.onlineshop.core.pay.alipay.alipayescow.sign.MD5;
import net.onlineshop.core.pay.alipay.alipayescow.util.httpClient.HttpProtocolHandler;
import net.onlineshop.core.pay.alipay.alipayescow.util.httpClient.HttpRequest;
import net.onlineshop.core.pay.alipay.alipayescow.util.httpClient.HttpResponse;
import net.onlineshop.core.pay.alipay.alipayescow.util.httpClient.HttpResultType;
