...
public class SitemapTask implements Runnable {
	...
	private void createSiteMap() {
		String websizePath = "D:\\workspace5\\onlineshop\\trunk\\onlineshop\\web\\";
...
//			}
	...
	private class FileDemo {
		...
		public void refreshList() {
			...
			logger.debug("refreshList...path = " + path);
			myDir = new File(path);

			fileList.clear();
			contents = myDir.listFiles();
			logger.debug("refreshList...myDir = " + myDir);
			logger.debug("refreshList...contents = " + contents);
			if(contents==null){
				currentFileIt = null;
				return ;
			}
