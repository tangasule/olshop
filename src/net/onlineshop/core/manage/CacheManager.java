//package net.onlineshop.core.manage;
//
//import java.io.File;
...
//import net.onlineshop.core.util.CreateAreaUtil;
//import net.onlineshop.services.manage.area.AreaService;
...
//import net.onlineshop.services.manage.comment.CommentService;
//import net.onlineshop.services.manage.comment.impl.CommentServiceImpl;
//import net.onlineshop.services.manage.commentType.bean.CommentType;
//import net.onlineshop.services.manage.keyvalue.KeyvalueService;
...
//import net.onlineshop.services.manage.pay.PayService;
//import net.onlineshop.services.manage.pay.bean.Pay;
//import net.onlineshop.services.manage.product.ProductService;
//import net.onlineshop.services.manage.product.bean.Product;
//import net.onlineshop.services.manage.systemSetting.SystemSettingService;
...
//		
////		logger.debug("SystemManager.areaMap=="+SystemManager.areaMap);
//		
...
//		logger.debug("getAreaByDigui data = " + data.size() + ",map = " + map.size());
...
//		
////		logger.debug("SystemManager.alipayConfig="+SystemManager.alipayConfig);
//		
//		/**
//		 * 加载评论配置
//		 */
