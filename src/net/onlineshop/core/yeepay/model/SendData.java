package net.onlineshop.core.yeepay.model;
...
public class SendData implements Serializable {
	...
	public String toString() {
		return "SendData [p0_Cmd=" + p0_Cmd + ", p1_MerId=" + p1_MerId + ", p2_Order=" + p2_Order + ", p3_Amt=" + p3_Amt + ", p4_Cur=" + p4_Cur + ", p5_Pid=" + p5_Pid + ", p6_Pcat=" + p6_Pcat + ", p7_Pdesc=" + p7_Pdesc + ", p8_Url=" + p8_Url + ", p9_SAF=" + p9_SAF + ", pa_MP=" + pa_MP
				+ ", pd_FrpId=" + pd_FrpId + ", pr_NeedResponse=" + pr_NeedResponse + ", hmac=" + hmac + "]";
	}
