<%@page import="net.onlineshop.core.oscache.FrontCache"%>
<%@page import="net.onlineshop.services.front.attribute.bean.Attribute"%>
<%@page import="net.onlineshop.services.front.product.bean.Product"%>
<%@page import="net.onlineshop.services.front.product.ProductService"%>
							...
							<s:if test="#request.isSearch==1">
								<s:if test="orderBy==1">
									<span class="label label-success attr_css" style="margin:5px;">
										<a href="<%=request.getContextPath() %>/search.html?orderBy=1&attributeID=<s:property escape="false" value="attributeID" />&key=${key}">热门</a>
									</span>
								</s:if>
								<s:else>
								...
								<s:if test="orderBy==2">
									<span class="label label-success attr_css" style="margin:5px;">
										<a href="<%=request.getContextPath() %>/search.html?orderBy=2&attributeID=<s:property escape="false" value="attributeID" />&key=${key}">价格</a>
									</span>
								</s:if>
								<s:else>
									<span class="label attr_css" style="margin:5px;">
								...
								<s:if test="orderBy==3">
									<span class="label label-success attr_css" style="margin:5px;">
										<a href="<%=request.getContextPath() %>/search.html?orderBy=3&attributeID=<s:property escape="false" value="attributeID" />&key=${key}">最新</a>
									</span>
								</s:if>
								<s:else>
									<span class="label attr_css" style="margin:5px;">
