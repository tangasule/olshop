			...
			<tr>
				...
				<td>
					<select name="e.orderpay.paymethod">
						<option value="alipayescow">支付宝</option>
...
<%-- 					<td>&nbsp;<s:property value="e.remark" /></td> --%>
			...
			<table class="table table-bordered">
				<tr>
					...
					<th nowrap="nowrap">${e.payType==1?'支付宝':e.payType==2?'易宝':'' }交易号</th>
				...
				<s:iterator value="e.orderpayList" status="i" var="orderpay">
					<tr>
						...
						<td><s:property value="paymethod" />
							<s:if test="paymethod.equals(\"alipayescow\")">
								<%=KeyValueHelper.get("orderpay_paymethod_alipayescow")%>
							</s:if>
							<s:elseif test="paymethod.equals(\"yeepay\")">
								<%=KeyValueHelper.get("orderpay_paymethod_yeepay")%>
							</s:elseif>
						</td>
				...
				<s:iterator value="e.orderlogs" status="i" var="orderlog">
					<tr>
						...
						<td>&nbsp;
							...
							<s:elseif test="accountType.equals(\"p\")">
								${e.payType==1?'支付宝':e.payType==2?'易宝':'其它' }
							</s:elseif>
							<s:else>
								未知
							</s:else>
