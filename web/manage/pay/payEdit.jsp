	...
	<s:form action="pay" namespace="/manage" theme="simple">
		<table class="table table-bordered">
			...
			<tr style="display: none;">
				<td>id</td>
				<td>
					<s:hidden name="e.id" label="id" />
					<s:hidden name="e.code" label="code" />
				</td>
			</tr>
			<tr>
				<td style="text-align: right;">支付方式</td>
				<td style="text-align: left;">
					<%-- <s:select list="#{'alipay':'支付宝','yeepay'}" name="e.code"/> --%>
					<s:textfield name="e.name"  id="name" readonly="true"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="text-align: left;"><s:textfield name="e.key1" data-rule="商户的私钥:required;key1;length[1~145];"  
						id="key1" /></td>
			</tr>
			<tr>
